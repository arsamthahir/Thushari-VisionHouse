    ...
    <div class="container">
        ...
        <div class="left-panel">
            <div class="hero-content">
                <div class="doctor-image">
                    <img src="/hospital/public/assets/images/adminlogin.png" alt="Admin Login" style="width:100%; height:100%; object-fit:cover; border-radius:20px;">
                ...
                <div class="text-content">
                    <h1 class="hero-title">Welcome Back to Admin Portal</h1>
                    <p class="hero-subtitle">Manage hospital operations, staff, and patient data with complete administrative control.</p>
                </div>
                ...
                <div class="stats">
                    ...
                    <div class="stat-item">
                        ...
                        <div class="stat-label">System Monitor</div>
                    </div>
                    <div class="stat-item">
        ...
        <div class="right-panel">
            <div class="form-header">
                ...
                <p class="form-subtitle">Sign in to your administrative account</p>
