        ...
        <div class="left-panel">
            <div class="hero-content">
                <div class="doctor-image">
                    <img src="/hospital/public/assets/images/userlogin.png" alt="Doctor Login" style="width:100%; height:100%; object-fit:cover; border-radius:20px;">
                ...
                <div class="text-content">
                    <h1 class="hero-title">Welcome Back to Your Health Portal</h1>
                    <p class="hero-subtitle">Access your medical records, appointments, and healthcare information securely.</p>
                </div>
